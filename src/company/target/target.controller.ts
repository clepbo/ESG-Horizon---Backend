...
export class TargetController {
  ...
  @ApiOperation({ 
    ...
    description: 'Create either a general target or scope-based target for the company'
  })
  @ApiBody({
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve all targets belonging to the authenticated user\'s company'
  })
  @ApiResponse({
  ...
  @ApiOperation({ 
    ...
    description: 'Retrieve a specific target by its ID (must belong to user\'s company)'
  })
  @ApiParam({
    name: 'id',
  ...
  async updateTarget(
    ...
    return await this.targetService.updateTarget(id, req.user.companyId, updateTargetDto);
  }
